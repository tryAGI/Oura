...
The Oura SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Oura
```
...
using var client = new OuraClient(
    apiKey: Environment.GetEnvironmentVariable("OURA_API_KEY")!);
