...
namespace Oura
{
    public partial class PersonalInfoRoutesClient
    {
        ...
        partial void ProcessSinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Oura.PersonalInfoResponse> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetAsync(
            global::Oura.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetAsResponseAsync(
        ...
        /// --header 'Authorization: Bearer &lt;token&gt;'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Oura.AutoSDKHttpResponse<global::Oura.PersonalInfoResponse>> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetAsResponseAsync(
            global::Oura.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Oura.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Oura.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGet",
                                methodName: "SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Oura.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Oura.PersonalInfoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Oura.AutoSDKHttpResponse<global::Oura.PersonalInfoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Oura.PersonalInfoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
